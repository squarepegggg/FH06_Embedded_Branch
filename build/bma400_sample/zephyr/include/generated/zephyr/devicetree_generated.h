...
#define DT_N_S_inputs_FOREACH_CHILD(fn) fn(DT_N_S_inputs_S_bmaint_2)
#define DT_N_S_inputs_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_inputs_S_bmaint_2)
#define DT_N_S_inputs_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_inputs_S_bmaint_2, __VA_ARGS__)
#define DT_N_S_inputs_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_inputs_S_bmaint_2, __VA_ARGS__)
#define DT_N_S_inputs_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_inputs_S_bmaint_2)
#define DT_N_S_inputs_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_inputs_S_bmaint_2)
#define DT_N_S_inputs_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_inputs_S_bmaint_2, __VA_ARGS__)
#define DT_N_S_inputs_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_inputs_S_bmaint_2, __VA_ARGS__)
...
/*
 * Devicetree node: /inputs/bmaint_2
 *
 * Node identifier: DT_N_S_inputs_S_bmaint_2
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_inputs_S_bmaint_2_PATH "/inputs/bmaint_2"

/* Node's name with unit-address: */
#define DT_N_S_inputs_S_bmaint_2_FULL_NAME "bmaint_2"
#define DT_N_S_inputs_S_bmaint_2_FULL_NAME_UNQUOTED bmaint_2
#define DT_N_S_inputs_S_bmaint_2_FULL_NAME_TOKEN bmaint_2
#define DT_N_S_inputs_S_bmaint_2_FULL_NAME_UPPER_TOKEN BMAINT_2

/* Node parent (/inputs) identifier: */
#define DT_N_S_inputs_S_bmaint_2_PARENT DT_N_S_inputs

/* Node's index in its parent's list of children: */
#define DT_N_S_inputs_S_bmaint_2_CHILD_IDX 0

/* Helpers for dealing with node labels: */
#define DT_N_S_inputs_S_bmaint_2_NODELABEL_NUM 1
#define DT_N_S_inputs_S_bmaint_2_FOREACH_NODELABEL(fn) fn(bmaint2)
#define DT_N_S_inputs_S_bmaint_2_FOREACH_NODELABEL_VARGS(fn, ...) fn(bmaint2, __VA_ARGS__)
#define DT_N_S_inputs_S_bmaint_2_FOREACH_ANCESTOR(fn) fn(DT_N_S_inputs) fn(DT_N)

/* Helper macros for child nodes of this node. */
#define DT_N_S_inputs_S_bmaint_2_CHILD_NUM 0
#define DT_N_S_inputs_S_bmaint_2_CHILD_NUM_STATUS_OKAY 0
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD(fn) 
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_inputs_S_bmaint_2_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's hash: */
#define DT_N_S_inputs_S_bmaint_2_HASH JwwfzqKDHjPa6PzdguxfE40M8Oo5VRoJyhkednDwyIA

/* Node's dependency ordinal: */
#define DT_N_S_inputs_S_bmaint_2_ORD 23
#define DT_N_S_inputs_S_bmaint_2_ORD_STR_SORTABLE 00023

/* Ordinals for what this node depends on directly: */
#define DT_N_S_inputs_S_bmaint_2_REQUIRES_ORDS \
	11, /* /soc/gpio@50000000 */ \
	22, /* /inputs */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_inputs_S_bmaint_2_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_inputs_S_bmaint_2_EXISTS 1
#define DT_N_ALIAS_int2        DT_N_S_inputs_S_bmaint_2
#define DT_N_NODELABEL_bmaint2 DT_N_S_inputs_S_bmaint_2

/* Macros for properties that are special in the specification: */
#define DT_N_S_inputs_S_bmaint_2_REG_NUM 0
#define DT_N_S_inputs_S_bmaint_2_RANGES_NUM 0
#define DT_N_S_inputs_S_bmaint_2_FOREACH_RANGE(fn) 
#define DT_N_S_inputs_S_bmaint_2_IRQ_NUM 0
#define DT_N_S_inputs_S_bmaint_2_IRQ_LEVEL 0
#define DT_N_S_inputs_S_bmaint_2_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_inputs_S_bmaint_2_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_inputs_S_bmaint_2_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_inputs_S_bmaint_2_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_50000000
#define DT_N_S_inputs_S_bmaint_2_P_gpios_IDX_0_VAL_pin 27
#define DT_N_S_inputs_S_bmaint_2_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_inputs_S_bmaint_2_P_gpios_IDX_0_VAL_flags 32
#define DT_N_S_inputs_S_bmaint_2_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_inputs_S_bmaint_2_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_inputs_S_bmaint_2, gpios, 0)
#define DT_N_S_inputs_S_bmaint_2_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_inputs_S_bmaint_2, gpios, 0)
#define DT_N_S_inputs_S_bmaint_2_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_inputs_S_bmaint_2, gpios, 0, __VA_ARGS__)
#define DT_N_S_inputs_S_bmaint_2_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_inputs_S_bmaint_2, gpios, 0, __VA_ARGS__)
#define DT_N_S_inputs_S_bmaint_2_P_gpios_LEN 1
#define DT_N_S_inputs_S_bmaint_2_P_gpios_EXISTS 1
#define DT_N_S_inputs_S_bmaint_2_P_label "BMA400 Interrupt 2"
#define DT_N_S_inputs_S_bmaint_2_P_label_STRING_UNQUOTED BMA400 Interrupt 2
#define DT_N_S_inputs_S_bmaint_2_P_label_STRING_TOKEN BMA400_Interrupt_2
#define DT_N_S_inputs_S_bmaint_2_P_label_STRING_UPPER_TOKEN BMA400_INTERRUPT_2
#define DT_N_S_inputs_S_bmaint_2_P_label_IDX_0 "BMA400 Interrupt 2"
#define DT_N_S_inputs_S_bmaint_2_P_label_IDX_0_EXISTS 1
#define DT_N_S_inputs_S_bmaint_2_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_inputs_S_bmaint_2, label, 0)
#define DT_N_S_inputs_S_bmaint_2_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_inputs_S_bmaint_2, label, 0)
#define DT_N_S_inputs_S_bmaint_2_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_inputs_S_bmaint_2, label, 0, __VA_ARGS__)
#define DT_N_S_inputs_S_bmaint_2_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_inputs_S_bmaint_2, label, 0, __VA_ARGS__)
#define DT_N_S_inputs_S_bmaint_2_P_label_LEN 1
#define DT_N_S_inputs_S_bmaint_2_P_label_EXISTS 1
