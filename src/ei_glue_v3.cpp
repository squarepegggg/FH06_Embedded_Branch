/**
 * ei_glue_v3.cpp - C-callable wrapper for the ei-v3 Edge Impulse model
 *
 * This file uses the ei-v3 model which expects 75 input features.
...
#include "tflite-model/tflite_learn_801862_19.h"

float demo_data[75] = {};
extern "C" {
    extern const unsigned int ei_model_arena_size  = EI_CLASSIFIER_TFLITE_LARGEST_ARENA_SIZE;
    extern const unsigned int ei_model_tflite_len  = tflite_learn_801862_19_len;
}

extern "C" int ei_v3_classify_test(const char **out_label, float *out_score)
{
