/**
 * ei_glue_v5.cpp - C-callable wrapper for the ei-v5 Edge Impulse model
 *
 * This file uses the ei-v5 model which expects 75 input features.
 ...
 * Callers fill demo_data[75], then call ei_v5_classify_test() to get the top class.
 */

#include "edge-impulse-sdk/classifier/ei_run_classifier.h"
#include "edge-impulse-sdk/dsp/numpy.hpp"
#include "model-parameters/model_metadata.h"
#include "tflite-model/tflite_learn_801862_31.h"
#include <stdio.h>
...
extern "C" {
    ...
    extern const unsigned int ei_model_tflite_len  = tflite_learn_801862_31_len;
}

extern "C" int ei_v5_classify_test(const char **out_label, float *out_score)
{
