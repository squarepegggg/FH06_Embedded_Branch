...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[39] = {
	{(const void *)0x3b6b9, (ISR)0x3ba65}, /* 0 */
	...
	{(const void *)0x20000a6c, (ISR)0x39f41}, /* 6 */
