...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_DEVICE_RUNTIME_DEFAULT_ENABLE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_BOSCH_BMA4XX_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 12);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_BUFFER_SIZE_UP, 4096);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_RTC_COUNTER_BIT_WIDTH, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_DEVICE_RUNTIME_ASYNC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_DEVICE_RUNTIME_USE_SYSTEM_WQ, 1);
